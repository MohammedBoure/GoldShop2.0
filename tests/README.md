...
* `test_excel_journal_features.py`: اختبارات مزايا يومية المبيعات بنمط إكسل وتعديل المبالغ والأوزان، والتحقق من الفرز والترتيب الآمن للتواريخ المختلطة (str وdatetime) في الاستعلام المجمع get_bulk_sales_for_excel.
...
* `test_coffre_transfer.py`: اختبارات تحويل واستبدال الإيرادات والذهب والفضة الكسر (O.C) من شريط الإجمالي باليومية إلى الخزينة (`replace_daily_transfer`)، التحقق من تفعيل أمر الاستبدال بالقائمة السياقية، وهيكل جدول الخزينة بـ 9 أعمدة وإجمالياتها.
