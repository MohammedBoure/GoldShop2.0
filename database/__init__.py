...
_MANAGER_EXPORTS = {
    ...
    "OfficialSupplierManager": ("supplier_manager", "SupplierManager"),
    ...
    "VersementManager": ("versement.versement_manager", "VersementManager"),
...
_MANAGER_ATTRS = {
    ...
    "official_suppliers": "SupplierManager",
    ...
    "client_command_payments": "ClientCommandsManager",
